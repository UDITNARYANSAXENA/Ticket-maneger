...
class Home extends Component {
  ...
  render() {
    ...
    const testimonials = [
      { quote: "SupportSync transformed our customer service experience!", author: "Udit Narayan Saxena, Tech Lead" },
      { quote: "Fast, reliable, and futuristic – highly recommend!", author: "Anshika Saxena, Manager" },
    ];
